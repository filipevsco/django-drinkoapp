...
from .views import HomeView, DrinkListView, DrinkCreateView, DrinkUpdateView, DrinkDeleteView, PubListView, PubCreateView, PubUpdateView, PubDeleteView, PubDetailView, DrinkDetailView
